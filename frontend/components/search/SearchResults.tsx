    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:gap-4">
        {results.map((result, index) => (
          ...
          >
            <Link
              href={`/entity/${result.entity_number}`}
              className="block group"
            >
              <motion.div
                className="bg-white rounded-xl border-2 p-4 sm:p-5 hover:shadow-xl cursor-pointer overflow-hidden relative group"
                style={{ borderColor: '#a7f3d0' }}
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3 sm:gap-4 relative z-10">
                  ...
                  <div className="shrink-0 flex flex-col items-end gap-3">
                    ...
                    {/* <div className="hidden sm:flex items-center gap-2 text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity" style={{ color: '#065F46' }}>
